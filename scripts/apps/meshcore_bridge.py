...
def lora_frame_to_companion_msgs(
    ...
    # Only handle MeshCore frames (sync_word 0x12 — in `carrier` since the
    # carrier/phy split landed).  DSP metadata (snr/rssi) stays in `phy`.
...
def main() -> None:
    ...
    # Print contact URIs (two incompatible formats)
