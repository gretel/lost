...
def connect_udp(
    ...
    # Subscribe unfiltered — monitor every decoded frame regardless of
    # sync word.  With promiscuous RX in lora_trx this catches MeshCore
    # (0x12), LoRaWAN (0x34), private nets, and anything else on-air.
