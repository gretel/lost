...
def _recv_until(
    ...
    """Receive exactly `count` companion frames, or raise on timeout."""
    sock.settimeout(timeout)
    buf = bytearray()
    frames: list[bytes] = []
    deadline = time.monotonic() + timeout
