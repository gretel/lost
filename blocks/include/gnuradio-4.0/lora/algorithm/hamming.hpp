...
inline constexpr std::array<uint8_t, 16> hamming_cw_LUT = {
    0, 23, 45, 58, 78, 89, 99, 116, 139, 156, 166, 177, 197, 210, 232, 255
};

/// Hamming LUT for soft ML decoding with CR = 4/5.
inline constexpr std::array<uint8_t, 16> hamming_cw_LUT_cr5 = {
